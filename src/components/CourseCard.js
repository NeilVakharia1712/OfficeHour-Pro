  ...
  return (
    <Card className={classes.card}>
      ...
      <CardActions>
        ...
        <Button variant='outlined' color='secondary' onClick={()=>{CheckIn(user, courseName, courseNumber)}} color="secondary" size="small">Check in</Button>
        <Button variant='outlined' color='secondary' onClick={()=>{CheckOut(user, courseName, courseNumber)}} color="secondary" size="small">Check Out</Button>
      </CardActions>
    </Card>
  );
}
